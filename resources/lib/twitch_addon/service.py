                        ...
                        if current_live:
                            ...
                            if not first_run or start:
                                if first_run and group_start:
                                    ...
                                    set_online_followed(window, current_online)
...
def get_followed_streams(twitch_api, monitor, blacklist_filter):
