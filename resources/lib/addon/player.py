                        ...
                        with dialog:
                            while (not monitor.abortRequested()) and (retries < max_retries) and (not dialog.is_canceled()):
                                ...
                                try:
                                    ...
                                    quality_label, play_url = converter.get_video_for_quality(videos, ask=False, quality=quality)
                                    ...
                                    if play_url:
                                        ...
                                        self.window.setProperty(self.reconnect_keys['stream'], ''.format(name, stream_name))
