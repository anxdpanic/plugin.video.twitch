...
def playLive(name):
	...
	xbmc.Player().play('http://usher.twitch.tv/select/' + name + '.m3u8?nauthsig=&nauth=&allow_source=true')
	PLUGIN.set_resolved_url('http://usher.twitch.tv/select/' + name + '.m3u8?nauthsig=&nauth=&allow_source=true')
